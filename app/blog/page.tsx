...
export default function BlogPage() {
  ...
  // CollectionPage Schema for GEO / SEO Indexing
        ...
        <div className="relative z-10 container-wide">
          ...
          <header className="mx-auto max-w-3xl text-center mb-12">
            ...
            <h1 className="font-display text-4xl sm:text-5xl font-extrabold tracking-tight text-foreground text-balance">
              Expert health insights, <span className="text-gradient">medically reviewed</span>
            </h1>
          ...
          <nav aria-label="Blog Categories" className="flex flex-wrap justify-center gap-2 mb-16">
            {blogCategories.map((cat) => (
              <Link
                ...
                className="rounded-full glass px-5 py-2 text-sm font-medium transition-all duration-300 hover:border-primary hover:text-primary hover:shadow-lg hover:shadow-primary/5"
              >
                {cat.name}
              </Link>
            ))}
                    ...
                    <article className="card-hover overflow-hidden rounded-3xl glass border border-border/80 flex flex-col h-full">
                      <div className="relative aspect-[16/10] overflow-hidden bg-muted">
                        ...
                        <div className="absolute top-3 left-3 z-10">
                          <span className="px-3 py-1 text-xs font-semibold rounded-full bg-background/80 backdrop-blur-md text-primary shadow-sm border border-border/50">
                            {article.category}
                          </span>
                        </div>
                      </div>
